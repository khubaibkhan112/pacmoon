...
<div class="nav-custom d-flex flex-column justify-content-between mCustomScrollbar" data-mcs-theme="minimal-dark" style="overflow-y:hidden; margin-top: 70px;">
    ...
    <div class="" style="overflow-x: hidden;padding:30px 28px 30px 32px;">
        ...
        <div class="col-12 ml-3 align-items-center">
            <div class="menu-link {{request()->is('template_categories/my-designs') ? 'active' : ''}} d-flex flex-row align-items-center mt-2 " style="padding:8px 0 8px 10px !important; margin-right: 40px !important; border-radius: 8px;">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <rect width="6" height="8" transform="matrix(1 0 0 -1 4 20)" stroke="#78889B" stroke-width="1.7" stroke-linecap="square"/>
                    <rect width="6" height="4" transform="matrix(1 0 0 -1 4 8)" stroke="#78889B" stroke-width="1.7" stroke-linecap="square"/>
                    <rect width="6" height="4" transform="matrix(1 0 0 -1 14 20)" stroke="#78889B" stroke-width="1.7" stroke-linecap="square"/>
                    <rect width="6" height="8" transform="matrix(1 0 0 -1 14 12)" stroke="#78889B" stroke-width="1.7" stroke-linecap="square"/>
                </svg>
                <div>
                    <a href="{{ route('categoryTemplate.index',['cat_id' => 'my-designs']) }}" class="{{ $category_id == 'my-designs' ? 'text-shape' : 'text-dark' }}">
                        <span class="custom-menu-text cursor-pointer" style="margin-left: 15px !important;">My Designs</span>
                    </a>
                </div>
            </div>
            <div class="menu-link d-flex flex-row align-items-center mt-2" style="padding:8px 0 8px 10px !important; margin-right: 40px !important; border-radius: 8px;">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M21.368 4.15137V17.6133H2.63196V4.15137H8.552" stroke="#78889B" stroke-width="1.8" stroke-linecap="square"/>
                    <path d="M9.0022 17.6133H14.9976L16.4976 21.0977H7.5022L9.0022 17.6133Z" stroke="#78889B" stroke-width="1.8" stroke-linecap="square"/>
                    <path d="M14.5522 3.71333C15.4044 2.86541 16.7821 2.86715 17.6322 3.71722V3.71722C18.4821 4.56714 18.4841 5.94456 17.6365 6.79684L11.2801 13.1885L8.16081 13.1885V10.0726L14.5522 3.71333Z" stroke="#78889B" stroke-width="1.8" stroke-linecap="square"/>
                    <path d="M13.5925 5.08101L16.4926 7.98112" stroke="#78889B" stroke-width="1.8" stroke-linecap="square"/>
                </svg>

            <div>
                <a href="{{route('editor.index')}}" class="text-dark">
                    <span class="custom-menu-text cursor-pointer" style="margin-left: 15px !important;">Build Your Own Content</span>
                </a>
            </div>

        </div>
        <div class="menu-link {{request()->is('template_categories/favourites') ? 'active' : ''}} d-flex flex-row align-items-center mt-2" style="padding:8px 0 8px 10px !important; margin-right: 40px !important; border-radius: 8px;">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M5.42223 5.52801C3.48484 7.46987 3.56744 10.7692 5.42229 13.5385C7.27714 16.3077 12.5 20 12.5 20C12.5 20 17.7227 16.3077 19.5777 13.2308C21.4326 10.1538 21.5151 7.46987 19.5778 5.52801C17.637 3.58274 14.5449 3.49483 12.5 5.26425C10.4551 3.49483 7.36301 3.58274 5.42223 5.52801Z" stroke="#78889B" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>

                <div>

                    <a href="{{ route('categoryTemplate.index', ['cat_id' => 'favourites']) }}" class="{{ $category_id == 'favourites' ? 'text-shape' : 'text-dark' }}"><span class="custom-menu-text cursor-pointer" style="margin-left: 15px !important;">My Favourites</span></a>

                </div>
            </div>
            <div class="menu-link menu-link-filled {{request()->is('template_categories/popular') ? 'active' : ''}} d-flex flex-row align-items-center mt-2" style="padding:8px 0 8px 10px !important; margin-right: 40px !important; border-radius: 8px;">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M10.7576 3.4967C11.1434 2.83443 12.1001 2.83443 12.4858 3.4967L14.6328 7.18273C14.7741 7.42533 15.0108 7.59736 15.2852 7.65678L19.4543 8.55958C20.2034 8.72178 20.499 9.63171 19.9883 10.2032L17.1462 13.3841C16.9591 13.5935 16.8687 13.8718 16.8969 14.1511L17.3266 18.3951C17.4038 19.1576 16.6298 19.72 15.9285 19.4109L12.025 17.6908C11.7681 17.5776 11.4754 17.5776 11.2185 17.6908L7.315 19.4109C6.61366 19.72 5.83963 19.1576 5.91683 18.3951L6.34653 14.1511C6.37482 13.8718 6.28438 13.5935 6.09731 13.3841L3.25512 10.2032C2.74447 9.63171 3.04012 8.72178 3.78917 8.55958L7.95823 7.65678C8.23263 7.59736 8.4694 7.42533 8.6107 7.18273L10.7576 3.4967Z" fill="#78889B"/>
                </svg>
                <div>
                    <a href="{{ route('categoryTemplate.index', ['cat_id' => 'popular']) }}" class="{{ $category_id == 'popular' ? 'text-shape' : 'text-dark' }}"><span class="custom-menu-text cursor-pointer" style="margin-left: 15px !important;">Most Popular Templates</span></a>
                </div>
            </div>
        ...
        <div class="col-12">
            <div class="accordion" id="accordionMenu">
                ...
                <div class="accordion-item {{ !in_array($category_id,['popular','favourites','my-designs']) ? 'active ' : '' }} accordion-main">
                    <div class="accordion-divider"></div> <!-- Vertical Divider -->
                    <div class="accordion-header bg-transparent" id="heading-all">
                        <button class="accordion-button bg-transparent {{ !in_array($category_id,['popular','favourites','my-designs']) ? '' : 'collapsed' }}" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-all" aria-expanded=" {{ !in_array($category_id,['popular','favourites','my-designs']) ? 'true' : 'false' }}" aria-controls="collapse-all"
                            ...
                            <svg style="margin-top: -3px;" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <path d="M2.5 9H9.5L13 6.5H18.5" stroke="#78889B" stroke-width="1.7" stroke-linejoin="round"/>
                            </svg>

                            <span class="custom-tab-heading" style="margin-left: 15px;">All Templates</span>
                        </button>
                    </div>
                    <div id="collapse-all" class="accordion-collapse {{ !in_array($category_id,['popular','favourites','my-designs']) ? 'show' : '' }} collapse" aria-labelledby="heading-all" data-bs-parent="#accordionMenu-collapse" >
                        <div class="accordion-body">
                            <ul class="list-unstyled mb-0">
                                ...
                                <div id="collapse-allcat" class="accordion-collapse collapse {{ $category_id == 'all' ? 'show' : '' }}" aria-labelledby="heading-all" data-bs-parent="#heading-all" >
                                    <a href="{{ route('categoryTemplate.index', ['cat_id' => 'all']) }}" class="{{ $category_id == 'all' ? 'text-shape' : 'text-dark' }}">
                                        <ul class="{{ $category_id == 'all' ? 'selected special-ul pt-2 pb-2 mb-1 mt-1' : 'pt-2 pb-2 mb-1 mt-1 special-ul' }}">
                                            Browse All
                                        </ul>
                                    </a>
                                </div> --}}
                                <a href="{{ route('categoryTemplate.index', ['cat_id' => 'all']) }}" >
                                    <div class="accordion parentAccord" id="categoryMenu_allcat">
                                        <div class="accordion-divider"></div>
                                    <ul class= "accordion-item inner p-0 m-0" >
                                ...
                                <div class="accordion parentAccord" id="categoryMenu{{$category->id}}">
                                        <div class="accordion-divider"></div>
                                    <ul class= "accordion-item inner p-0 m-0" data-bs-toggle="collapse" data-bs-target="#collapse{{$category->id}}" aria-expanded="false" aria-controls="collapse{{ $category->id }}">
                                        <div class="catNameDrop border-2">
                                            {{$category->title}}
                                        </div>

                                            <div id="collapse{{ $category->id }}" class="accordion-collapse collapse {{ $category_id == $category->id ? 'show' : '' }}" aria-labelledby="heading{{ $category->id }}" data-bs-parent="#categoryMenu{{$category->id}}" >
                                                <a href="{{ route('categoryTemplate.index', ['cat_id' => $category->id]) }}" class="{{ $category_id == $category->id &&  $sub_category_id == "" ? 'text-shape' : 'text-dark' }}">
                                                <ul class="{{ $category_id == $category->id &&  $sub_category_id ? 'selected special-ul pt-2 pb-2 mb-1 mt-1 ml-1' : 'pt-2 pb-2 ml-1 mb-1 mt-1 special-ul' }}">
                                                    Browse All
                                                </ul>
                                                </a>
                                            </div>
                                        @foreach($category->sub_categories as $sub_category)
                                            ...
                                            <div id="collapse{{ $category->id }}" class="accordion-collapse collapse {{ $category_id == $category->id ? 'show' : '' }}" aria-labelledby="heading{{ $category->id }}" data-bs-parent="#categoryMenu{{$category->id}}" >
                                                <a href="{{ route('categoryTemplate.index', ['cat_id' => $category->id, "sub_cat_id"=>$sub_category->id]) }}" class="{{ $sub_category_id == $sub_category->id ? 'text-shape' : 'text-dark' }}">
                                                <ul class="{{ $sub_category_id == $sub_category->id ? 'selected special-ul pt-2 pb-2 mb-1 mt-1 ml-3 border-2' : 'pt-2 pb-2 mb-1 mt-1 ml-3 border-2 special-ul' }}">
                                                    {{ $sub_category->name }}
                                                </ul>
                                                </a>
                                            </div>
...
{{--    <div class="">--}}
{{--        <hr style="border-color: #eeeeee !important;margin: 0;">--}}
{{--        <div class="accordion" id="accordionMenu-settings">--}}
{{--            <div class="col-12">--}}
{{--                --}}{{-- <div class="d-flex flex-row align-items-center mt-2 @if(request()->is('/profile')) selected @endif" style="padding:8px 0 8px 10px !important; margin-right: 40px !important; border-radius: 8px;">--}}
...
{{--                        <a href="{{ route('profile.edit') }}" class="{{ request()->is('/profile') ? 'text-shape' : 'text-dark' }}">--}}
{{--                            <span class="custom-menu-text cursor-pointer" style="margin-left: 15px !important;">Settings</span>--}}
{{--                        </a>--}}
{{--                    </div>--}}
{{--                </div> --}}
{{--                --}}{{-- <div class="accordion" id="accordionMenu">--}}
